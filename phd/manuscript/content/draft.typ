For example, the trajectory of a celestial body can appear chaotic to an external observer (depending on her point of view) even if it is actually deterministic.
